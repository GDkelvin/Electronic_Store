    ...
    return (
        <>
            <nav className="navbar">
                ...
                <div className={`nav-link ${isMobileMenuOpen ? "mobile-menu-open" : ""}`}>
                    <div className="nav-links-container">
                        <div><Link to="/" className={location.pathname === "/" ? "active" : ""} onClick={() => setIsMobileMenuOpen(false)}>Home</Link></div>
                        <div className="nav-dropdown-menu" onMouseEnter={() => setIsCategoryMenuOpen(true)} onMouseLeave={() => setIsCategoryMenuOpen(false)}>
                            <Link to="/products" className={location.pathname.startsWith("/product") ? "active" : ""} onClick={() => setIsMobileMenuOpen(false)}>Products</Link>
                        </div>
                        <div><Link to="/contact" onClick={() => setIsMobileMenuOpen(false)}>Contact Us</Link></div>
                    </div>
                </div>
